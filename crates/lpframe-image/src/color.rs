//! sRGB/OKLab conversion and dominant-colour extraction.
//!
//! The renderer uses the palette for the `dominant` and `gradient` background
//! modes; the enrichment gate uses the same conversion to compare two covers.
//!
